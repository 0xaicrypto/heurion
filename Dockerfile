...
# Web UI static bundle. This is built outside Docker (e.g. locally or in
# CI) and copied into the image. The server serves it at /; see
# nexus_server/main.py for the mount logic.
