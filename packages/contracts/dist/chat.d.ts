...
export declare const CHAT_EVENT_TYPES: readonly ['turn_started', 'context_usage', 'compaction_started', 'compaction_chunk', 'compaction_completed', 'compaction_summary', 'doc_updated', 'chart_created', 'tier_classified', 'context_info', 'reasoning_chunk', 'thought', 'tool_call', 'tool_result', 'subagent_started', 'subagent_progress', 'subagent_done', 'memory_hits', 'image_attached', 'sidecar_file', 'final_answer_chunk', 'citations', 'skill_capture_suggest', 'truncated', 'intent_clarify', 'attachment_export_option', 'citation_audit', 'turn_complete', 'error', 'plugin_selected', 'payload_building', 'job_enqueued', 'job_status', 'file_ready'];
